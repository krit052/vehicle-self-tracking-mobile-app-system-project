...
final _mockRoutes = [
  _RouteEntry(
    ...
    waypoints: const [
      LatLng(18.9143, 99.0490),
      LatLng(18.9148, 99.0495),
      LatLng(18.9155, 99.0502),
      LatLng(18.9160, 99.0510),
    ],
  ),
  _RouteEntry(
    id: 'r2',
    startTime: DateTime.now().subtract(const Duration(hours: 5, minutes: 30)),
    endTime: DateTime.now().subtract(const Duration(hours: 5, minutes: 5)),
    waypoints: const [
      LatLng(18.9160, 99.0510),
      LatLng(18.9152, 99.0500),
      LatLng(18.9143, 99.0490),
    ],
  ),
  _RouteEntry(
    ...
    endTime: DateTime.now().subtract(const Duration(days: 1, hours: 2, minutes: 40)),
    waypoints: const [
      LatLng(18.9143, 99.0490),
      LatLng(18.9138, 99.0485),
      LatLng(18.9130, 99.0478),
    ],
  ),
];
...
class _RouteHistoryScreenState extends State<RouteHistoryScreen> {
  ...
  List<_RouteEntry> get _filteredRoutes {
    if (_selectedDate == null) return _mockRoutes;
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                final isToday = date.day == now.day &&
                    ...
                    date.year == now.year;
                final hasRoutes = _mockRoutes.any((r) =>
                    r.startTime.day == day &&
                    ...
                    children: [
                      ...
                      AnimatedOpacity(
                        ...
                        child: Container(
                          ...
                          height: 5,
                          decoration: BoxDecoration(
                            color: isSelected ? Colors.white : AppColors.secondaryContainer,
                            shape: BoxShape.circle,
                          ),
                        ),
                      ),
      ...
      child: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              initialCenter: polylinePoints.isNotEmpty ? polylinePoints.first : _mfuCenter,
              initialZoom: 17,
                ...
                MarkerLayer(
                  markers: [
                    Marker(
                      ...
                      width: 28,
                      height: 28,
                      child: _RouteEndpoint(color: const Color(0xFF1E8A3E), icon: Icons.trip_origin),
                    ),
                    Marker(
                      point: polylinePoints.last,
                      width: 28,
                      height: 28,
                      child: _RouteEndpoint(color: AppColors.error, icon: Icons.location_on),
                    ),
                  ],
                ),
            ],
            ...
            child: Column(
              children: [
                _MapFab(
                  ...
                  onTap: () {
                    final center = polylinePoints.isNotEmpty ? polylinePoints.first : _mfuCenter;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ...routes.asMap().entries.map((e) => _RouteCard(
                entry: e.value,
                index: e.key,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.history, size: 36, color: AppColors.onSurfaceVariant),
          ),
  ...
  String _dayLetter(int weekday) => const ['M', 'T', 'W', 'T', 'F', 'S', 'S'][weekday - 1];
}
...
class _RouteEntry {
  ...
  String get distanceLabel {
    ...
    return total >= 1 ? '${total.toStringAsFixed(1)} km' : '${(total * 1000).round()} m';
  }
